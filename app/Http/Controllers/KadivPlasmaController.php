...
class KadivPlasmaController extends Controller
{
    /**
    ...
    public function dashboard()
    {
        ...
        // Statistik - WO yang diterima oleh divisi Plasma
        $totalWODiterima = SuratPengajuan::where('ditujukan', 'LIKE', '%Plasma%')
            ->where('id_divisi', '!=', $userDivisi)
            ->count();
        ...
        return view('kadivplasma.dashboard', compact(
            'totalWODibuat',
            'totalWODiterima',
            'woPending',
            'woSelesai',
    ...
    public function workOrder()
    {
        ...
        $userDivisiNama = DB::table('divisi')->where('id_divisi', $userDivisi)->value('nama_divisi') ?? 'Plasma';
    ...
    public function daftarWorkOrder()
    {
        ...
        return view('kadivplasma.daftar_work_order', compact('workOrders'));
    }
    ...
    public function riwayatWorkOrder()
    {
        ...
        return view('kadivplasma.riwayat_work_order', compact('workOrders'));
    }
    ...
    public function storeWorkOrder(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kadivplasma.work-order', ['from' => 'crud'])->with('success', 'Data berhasil ditambahkan');
        } catch (\Exception $e) {
            return redirect()->route('kadivplasma.work-order')->with('error', 'Gagal membuat work order: ' . $e->getMessage());
        }
    }
    ...
    public function updateWorkOrder(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('kadivplasma.work-order', ['from' => 'crud'])->with('success', 'Data berhasil diperbarui');
        } catch (\Exception $e) {
            return redirect()->route('kadivplasma.work-order')->with('error', 'Gagal mengupdate work order: ' . $e->getMessage());
        }
    }
    ...
    public function hapusWorkOrder($id)
    {
        try {
            ...
            return response()->json([
                ...
                'redirect' => route('kadivplasma.work-order')
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
        ...
        try {
            ...
            if ($workOrder->ditujukan !== $userDivisiNama) {
                ...
                return response()->json([
                    ...
                    'redirect' => route('kadivplasma.daftar-work-order', ['from' => 'crud'])
                ], 403);
            }
            ...
            $redirectUrl = route('kadivplasma.daftar-work-order', ['from' => 'crud']);
    ...
    public function profile()
    {
        ...
        return view('kadivplasma.profile', compact('user'));
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kadivplasma.profile', ['from' => 'crud'])->with('success', 'Data berhasil diperbarui');
        } catch (\Exception $e) {
    ...
    public function changePassword(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kadivplasma.profile', ['from' => 'crud'])->with('success', 'Password berhasil diubah!');
        } catch (\Exception $e) {
