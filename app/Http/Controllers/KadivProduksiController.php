...
class KadivProduksiController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $totalWODiterima = SuratPengajuan::where('ditujukan', 'LIKE', '%Produksi%')
            ->where('id_divisi', '!=', $userDivisi)
            ->count();
    ...
    public function storeWorkOrder(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kadivproduksi.work-order')->with('error', 'Gagal membuat work order: ' . $e->getMessage());
        }
    }
    ...
    public function updateWorkOrder(Request $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('kadivproduksi.work-order')->with('error', 'Gagal mengupdate work order: ' . $e->getMessage());
        }
    }
    ...
    public function hapusWorkOrder($id)
    {
        try {
            ...
            return response()->json([
                ...
                'redirect' => route('kadivproduksi.work-order')
            ]);
        } catch (\Exception $e) {
            return response()->json([
                'success' => false,
        ...
        try {
            ...
            if ($workOrder->ditujukan !== $userDivisiNama) {
                ...
                return response()->json([
                    ...
                    'redirect' => route('kadivproduksi.daftar-work-order', ['from' => 'crud'])
                ], 403);
            }
            ...
            $redirectUrl = route('kadivproduksi.daftar-work-order', ['from' => 'crud']);
    ...
    public function profile()
    {
        ...
        return view('kadivproduksi.profile', compact('user'));
    }
    ...
    public function updateProfile(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kadivproduksi.profile', ['from' => 'crud'])->with('success', 'Data berhasil diperbarui');
        } catch (\Exception $e) {
    ...
    public function changePassword(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('kadivproduksi.profile', ['from' => 'crud'])->with('success', 'Password berhasil diubah!');
        } catch (\Exception $e) {
