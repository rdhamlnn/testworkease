...
<head>
    ...
    <title>@yield('title', 'Dashboard Mekanik') - WorkEase KCE</title>
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <div class="d-sm-none d-lg-inline-block">{{ session('jabatan') ?? 'Mekanik' }}</div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Logged in</div>
                            <a href="{{ route('mekanik.profile') }}" class="dropdown-item has-icon">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ request()->is('mekanik/dashboard') ? 'active' : '' }}">
                            <a href="{{ url('/mekanik/dashboard') }}" class="nav-link">
                                <i class="fas fa-fire"></i> <span>Dashboard</span>
                            </a>
                        </li>

                        <li class="menu-header">Laporan & Arsip</li>
                        <li class="dropdown {{ request()->is('mekanik/laporan*') ? 'active' : '' }}">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                                <i class="fas fa-file-alt"></i> 
                                <span>Laporan & Arsip</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="{{ request()->is('mekanik/laporan-harian-mekanik*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/mekanik/laporan-harian-mekanik') }}">
                                        <i class="fas fa-calendar-check"></i>
                                        <span>Laporan Harian Mekanik</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('mekanik/laporan-pemakaian-barang*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/mekanik/laporan-pemakaian-barang') }}">
