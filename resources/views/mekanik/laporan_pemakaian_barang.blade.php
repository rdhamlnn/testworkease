    ...
    function updateTable(data) {
        ...
        if (data && data.length > 0) {
            for (var i = 0; i < data.length; i++) {
                ...
                html += '<button type="button" class="btn btn-info btn-sm btn-view" data-id="' + item.id_laporan_pemakaian_barang + '" data-toggle="modal" data-target="#viewLaporanModal"><i class="fas fa-eye"></i></button>';
                html += '</div>';
                html += '</td>';
                html += '</tr>';
            }
