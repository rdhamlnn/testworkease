...
<section class="section">
    ...
    <div class="section-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <a href="{{ route('mekanik.dashboard') }}" class="btn btn-back">
        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="card profile-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('mekanik.profile.update') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" 
                                               value="{{ session('nama_lengkap') ?? 'Mekanik' }}" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" 
                                               value="{{ session('email') ?? 'mekanik@kce.com' }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="jabatan" name="jabatan" value="{{ session('jabatan', 'Mekanik') }}" required>
                            </div>
            ...
            <div class="col-lg-6">
                <div class="card profile-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('mekanik.profile.change-password') }}" method="POST">
                            @csrf
                            @method('PUT')
