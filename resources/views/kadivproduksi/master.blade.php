...
<head>
    ...
    <title>@yield('title', 'Dashboard Kadiv Produksi') - WorkEase KCE</title>
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <div class="d-sm-none d-lg-inline-block">{{ session('jabatan') ?? 'Kadiv Produksi' }}</div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Logged in</div>
                            <a href="{{ route('kadivproduksi.profile') }}" class="dropdown-item has-icon">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('kadivproduksi.dashboard') }}">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ request()->is('kadivproduksi/dashboard') ? 'active' : '' }}">
                            <a href="{{ url('/kadivproduksi/dashboard') }}" class="nav-link">
                                <i class="fas fa-fire"></i> <span>Dashboard</span>
                            </a>
                        </li>

                        <li class="menu-header">Work Order</li>
                        <li class="dropdown {{ request()->is('kadivproduksi/work-order*') || request()->is('kadivproduksi/daftar-work-order*') || request()->is('kadivproduksi/riwayat-work-order*') ? 'active' : '' }}">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                                <i class="fas fa-briefcase"></i> <span>Work Order</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="{{ request()->is('kadivproduksi/work-order') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/kadivproduksi/work-order') }}">
                                        <i class="fas fa-plus-square"></i>
                                        <span>Ajukan Work Order</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('kadivproduksi/daftar-work-order*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/kadivproduksi/daftar-work-order') }}">
                                        <i class="fas fa-inbox"></i>
                                        <span>Work Order Masuk</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('kadivproduksi/riwayat-work-order*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/kadivproduksi/riwayat-work-order') }}">
