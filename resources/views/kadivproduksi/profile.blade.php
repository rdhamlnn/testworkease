...
<section class="section">
    ...
    <div class="section-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <a href="{{ route('kadivproduksi.dashboard') }}" class="btn btn-back">
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="card profile-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('kadivproduksi.profile.update') }}" method="POST">
                            @csrf
                            @method('PUT')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="divisi" name="divisi" 
                                               value="{{ $user->nama_divisi ?? 'Produksi' }}" readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="jabatan" name="jabatan" 
                                               value="{{ $user->jabatan ?? session('jabatan', 'Kadiv Produksi') }}" required>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-6">
                <div class="card profile-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('kadivproduksi.profile.change-password') }}" method="POST">
                            @csrf
                            @method('PUT')
