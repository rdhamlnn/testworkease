...
<script>
    $(document).ready(function() {
        ...
        $('#filterStatus').on('change', function() {
            var status = $(this).val();
            // Kolom Status adalah index 11 (setelah: No, No WO, Jenis, Divisi, Tanggal, Unit, Barang, Qty, Satuan, Total Harga, Uraian, Status)
            if (status === '') {
        ...
        table.column(4).data().each(function(value) {
            // value is the data-order attribute (YYYY-MM-DD format)
        ...
        $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
            ...
            if (settings.nTable.id !== 'riwayatWorkOrderTable') {
                return true;
            }
            ...
            // Get date from column 4 (Hari/Tanggal) - data-order attribute
            ...
            var rowYear = dateValue.substring(0, 4);
            var rowMonth = dateValue.substring(5, 7);
