...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item"><a href="{{ route('logistik.work-order-dicek') }}">Work Order Dicek</a></div>
            <div class="breadcrumb-item active">Buat Permintaan Barang</div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('logistik.permintaan-barang.store') }}" method="POST" id="formPermintaanBarang">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="tanggal_permintaan" name="tanggal_permintaan" value="{{ date('Y-m-d') }}" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div id="daftarBarangContainer">
                                <div class="row mb-3 barang-item">
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" class="form-control nama-barang" name="barang[0][nama_barang]" required placeholder="Masukkan nama barang">
                                    </div>
                                    <div class="col-md-2">
                                        <label>Jumlah <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control jumlah-barang" name="barang[0][jumlah]" min="1" required placeholder="Jumlah">
                                    </div>
                                    <div class="col-md-2">
                                        <label>Satuan <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control satuan-barang" name="barang[0][satuan]" placeholder="pcs/kg" required>
                                    </div>
                                    <div class="col-md-3">
                                        <label>Estimasi Harga <span class="text-danger">*</span></label>
                                        <input type="number" class="form-control harga-barang" name="barang[0][estimasi_harga]" min="0" required placeholder="Masukkan estimasi harga">
                                    </div>
                                    <div class="col-md-1">
                                        <label>&nbsp;</label>
                                        <button type="button" class="btn btn-danger btn-block btn-remove-item" style="display:none;">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="totalEstimasiHarga" readonly style="font-size: 18px; font-weight: bold;">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="catatan_logistik" name="catatan_logistik" rows="3" placeholder="Masukkan catatan jika diperlukan"></textarea>
                            </div>

                            <div class="form-group text-right">
                                <a href="{{ route('logistik.work-order-dicek') }}" class="btn btn-secondary">Batal</a>
...
<script>
    ...
    function addBarangItem() {
        ...
        // Show remove button for first item if more than one
