...
<head>
    ...
    <title>@yield('title', 'Dashboard Kadiv Mekanik') - WorkEase KCE</title>
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <div class="d-sm-none d-lg-inline-block">{{ session('jabatan') ?? 'Kepala Divisi Mekanik' }}</div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Logged in</div>
                            <a href="{{ route('kadivmekanik.profile') }}" class="dropdown-item has-icon">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('kadivmekanik.dashboard') }}">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ request()->is('kadivmekanik/dashboard') ? 'active' : '' }}">
                            <a href="{{ url('/kadivmekanik/dashboard') }}" class="nav-link">
                        ...
                        <li class="dropdown {{ request()->is('kadivmekanik/work-order*') || request()->is('kadivmekanik/daftar-pengajuan-work-order*') || request()->is('kadivmekanik/riwayat-work-order*') ? 'active' : '' }}">
                            ...
                            <ul class="dropdown-menu">
                                <li class="{{ request()->is('kadivmekanik/work-order') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/kadivmekanik/work-order') }}">
                                ...
                                <li class="{{ request()->is('kadivmekanik/riwayat-work-order*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/kadivmekanik/riwayat-work-order') }}">
                        ...
                        <li class="dropdown {{ request()->is('kadivmekanik/laporan*') ? 'active' : '' }}">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                                <i class="fas fa-file-alt"></i> 
                                <span>Laporan & Arsip</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="{{ request()->is('kadivmekanik/laporan-harian-mekanik*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/kadivmekanik/laporan-harian-mekanik') }}">
                                        <i class="fas fa-calendar-check"></i>
                                        <span>Laporan Harian Mekanik</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('kadivmekanik/laporan-pemakaian-barang*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/kadivmekanik/laporan-pemakaian-barang') }}">
