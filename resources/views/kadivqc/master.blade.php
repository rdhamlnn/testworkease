...
<head>
    ...
    <title>@yield('title', 'Dashboard Kadiv Quality Control') - WorkEase KCE</title>
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <div class="d-sm-none d-lg-inline-block">{{ session('jabatan') ?? 'Kadiv Quality Control' }}</div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Logged in</div>
                            <a href="{{ route('kadivqc.profile') }}" class="dropdown-item has-icon">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('kadivqc.dashboard') }}">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ request()->is('kadivqc/dashboard') ? 'active' : '' }}">
                            <a href="{{ url('/kadivqc/dashboard') }}" class="nav-link">
                                <i class="fas fa-fire"></i> <span>Dashboard</span>
                            </a>
                        </li>

                        <li class="menu-header">Work Order</li>
                        <li class="dropdown {{ request()->is('kadivqc/work-order*') || request()->is('kadivqc/daftar-work-order*') || request()->is('kadivqc/riwayat-work-order*') ? 'active' : '' }}">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                                <i class="fas fa-briefcase"></i> <span>Work Order</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="{{ request()->is('kadivqc/work-order') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/kadivqc/work-order') }}">
                                        <i class="fas fa-plus-square"></i>
                                        <span>Ajukan Work Order</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('kadivqc/daftar-work-order*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/kadivqc/daftar-work-order') }}">
                                        <i class="fas fa-inbox"></i>
                                        <span>Work Order Masuk</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('kadivqc/riwayat-work-order*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ url('/kadivqc/riwayat-work-order') }}">
