                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div style="display: flex; gap: 5px;">
                                            ...
                                            @if($status == 'Menunggu')
                                                <form action="{{ route('kadivplasma.approve-work-order', $wo->id_surat_pengajuan) }}" method="POST" class="approve-form" style="display:inline;" 
                                                ...
                                                <form action="{{ route('kadivplasma.reject-work-order', $wo->id_surat_pengajuan) }}" method="POST" class="reject-form" style="display:inline;" 
