...
<head>
    ...
    <title>@yield('title', 'Dashboard Purchasing') - WorkEase KCE</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/modules/select2/dist/css/select2-bootstrap4.min.css') }}">
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <div class="d-sm-none d-lg-inline-block">{{ session('jabatan') ?? 'Purchasing' }}</div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Logged in</div>
                            <a href="{{ route('purchasing.profile') }}" class="dropdown-item has-icon">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ request()->is('purchasing/dashboard') ? 'active' : '' }}">
                            <a href="{{ url('/purchasing/dashboard') }}" class="nav-link">
                                <i class="fas fa-fire"></i> <span>Dashboard</span>
                            </a>
                        </li>

                        <li class="menu-header">Work Order</li>
                        <li class="dropdown {{ request()->is('purchasing/work-order*') || request()->is('purchasing/daftar-work-order*') || request()->is('purchasing/riwayat-work-order*') ? 'active' : '' }}">
                            <a href="#" class="nav-link has-dropdown" data-toggle="dropdown">
                                <i class="fas fa-briefcase"></i> <span>Work Order</span>
                            </a>
                            <ul class="dropdown-menu">
                                <li class="{{ request()->is('purchasing/work-order') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('purchasing.work-order') }}">
                                        <i class="fas fa-plus-square"></i>
                                        <span>Ajukan Work Order</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('purchasing/daftar-work-order*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('purchasing.daftar-work-order') }}">
                                        <i class="fas fa-inbox"></i>
                                        <span>Work Order Masuk</span>
                                    </a>
                                </li>
                                <li class="{{ request()->is('purchasing/riwayat-work-order*') ? 'active' : '' }}">
                                    <a class="nav-link" href="{{ route('purchasing.riwayat-work-order') }}">
