...
<section class="section">
    <div class="section-header">
        ...
        <div class="section-header-breadcrumb">
            ...
            <div class="breadcrumb-item active">Kirim Barang</div>
        </div>
    </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Daftar Barang yang Perlu Dikirim</h4>
                    </div>
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped" id="kirimBarangTable">
                                ...
                                <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="display: flex; gap: 5px;">
                                                            ...
                                                            <form action="{{ route('purchasing.kirim-barang.proses', $pb->id_permintaan_barang) }}" method="POST" class="confirm-form" style="display:inline;" 
                                                                data-message="Yakin barang sudah dikirim ke Logistik?"
                                                                data-description="Tindakan ini akan mengkonfirmasi bahwa barang sudah dikirim ke Logistik."
                                                                data-button-text="Ya, Konfirmasi"
                                                                data-button-class="btn-primary">
                                                                @csrf
                                                                <button type="submit" class="btn btn-primary btn-sm btn-icon" title="Konfirmasi Pengiriman">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center text-muted">Belum ada barang yang perlu dikirim</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>
    ...
    $(document).ready(function() {
        $('#kirimBarangTable').DataTable({
            ...
            "language": {
                ...
                "emptyTable": "Tidak ada barang yang perlu dikirim"
            }
        });
