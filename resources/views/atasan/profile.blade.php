...
<section class="section">
    ...
    <div class="section-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <a href="{{ route('atasan.dashboard') }}" class="btn btn-back">
        ...
        <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="divisi" name="divisi" 
                                               value="{{ $user->nama_divisi ?? 'Atasan' }}" readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="jabatan" name="jabatan" 
                                               value="{{ $user->jabatan ?? session('jabatan', 'Atasan') }}" required>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="col-lg-6">
                <div class="card profile-card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('atasan.profile.change-password') }}" method="POST">
                            @csrf
                            @method('PUT')
