...
<head>
    ...
    <title>@yield('title', 'Dashboard Atasan') - WorkEase KCE</title>
                ...
                <ul class="navbar-nav navbar-right">
                    <li class="dropdown">
                        <a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <div class="d-sm-none d-lg-inline-block">{{ session('jabatan') ?? 'Atasan' }}</div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="dropdown-title">Logged in</div>
                            <a href="{{ route('atasan.profile') }}" class="dropdown-item has-icon">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ request()->is('atasan/dashboard') ? 'active' : '' }}">
                            <a href="{{ url('/atasan/dashboard') }}" class="nav-link">
